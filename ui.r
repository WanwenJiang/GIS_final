...
shinyUI(navbarPage("Interactive Map of Malaria Deaths and Cases by Country",
                   tabPanel("Summary",
                        p(strong("Malaria"),"is the", code("number one"), "infectious disease that kills the most people worldwide every year. Although rates of 
                            ...
                            "data repository in the WHO website. This data contains number of reported deaths and cases from years", strong("2003"), "to", strong("2017"), "in", code("109"), 
                            ...
                            sidebarLayout(
                              ...
                              sidebarPanel(
                                selectInput('deaths', label = 'Select a year',
                                            choices = list("2017 deaths" = "X2017.malaria.deaths",
                                                           "2016 deaths" = "X2016.malaria.deaths", 
                                                           "2015 deaths" = "X2015.malaria.deaths",
                              ...
                              mainPanel(
                                ...
                                br(),
                                br(),
                                p("This map shows the malaria deaths per each country in a specific year from 2003-2017
                            ...
                            sidebarLayout(
                              ...
                              sidebarPanel(
                                selectInput('cases', label = 'Select a year',
                                            choices = list("2017 cases" = "X2017.malaria.cases",
                                                           "2016 cases" = "X2016.malaria.cases", 
                                                           "2015 cases" = "X2012.malaria.cases",
                                                           "2014 cases" = "X2014.malaria.cases",
                              ...
                              mainPanel(
                                ...
                                br(),
                                br(),
                                p("This map shows the malaria cases per each country in a specific year from 2003-2017
                   ...
                   tabPanel("Scatter Plot of Change in Deaths",
                            ...
                            titlePanel("Change in Malaria Deaths Between 2003 and 2017"),
                            ...
                            sidebarLayout(
                              ...
                              mainPanel(
                                ...
                                br(),
                                br(),
                                p("The chart shows the change in malaria deaths per country from 2003 to 2017.
                                  The size of the circle shows the magnitude of the decrease in deaths over the 14-year period.
                                  Hover over the dot to show the deaths in 2003 followed by the deaths in 2017. For some countries,
                   ...
                   tabPanel("Bar Graph of Mean Cases/Deaths per Region in 2017",
                            #
                            titlePanel("Mean Cases/Deaths per Region in 2017"),
                            ...
                            sidebarLayout(
                              ...
                              mainPanel(
                                ...
                                br(),
                                br(),
                                p("This chart shows the mean deaths/cases per region of the world in 2017. See the detailed region tab
                                  for more info. Hover over a bar to see the exact means. The WHO does not have data for Malaria cases/deaths
                                  for Europe, however.")
                              )
                            )
                   ),
                   # Panel for the interactive plotly world map of cases/deaths per 1000 people per country in 2017
                   tabPanel("Interactive Map of Deaths/Cases per 1000",
                            
                            titlePanel("Malaria Deaths/Cases per 1000 people per Country in 2017"),
                            ...
                            sidebarLayout(
                              ...
                              sidebarPanel(
                                selectInput('mPer1000var', label = 'Select cases/deaths',
                                            choices = list("2017 cases per 1000" = "malaria.cases.per.1000",
                                                           "2017 deaths per 1000" = "malaria.deaths.per.1000"))
                              ),
                              ...
                              mainPanel(
                                ...
                                br(),
                                br(),
                                p("This map shows the number of deaths/cases per country per 1000 people in 2017.
                                  Hover over a country to show exact number of cases and other info.")
                                )
                            )
                    )        
